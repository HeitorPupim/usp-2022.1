...
public class Tela extends javax.swing.JFrame implements MouseListener, KeyListener {
    ...
    public Tela() {
        ...
        //Aqui temos que configurar os níveis e implementar onde cada
        // coisa vai spawnar.
        
        /*  ---> isso vai ser implementado nas fases.
        lLolo = new Lolo();
        lLolo.setPosicao(0, 7);
        this.addPersonagem(lLolo);

        BichinhoVaiVemHorizontal bBichinhoH = new BichinhoVaiVemHorizontal(false);
        bBichinhoH.setPosicao(3, 3);
        this.addPersonagem(bBichinhoH);

        BichinhoVaiVemHorizontal bBichinhoH2 = new BichinhoVaiVemHorizontal(false);
        bBichinhoH2.setPosicao(6, 6);
        this.addPersonagem(bBichinhoH2);

        BichinhoVaiVemHorizontal bBichinhoH3 = new BichinhoVaiVemHorizontal(true);
        ...
        ZigueZague zz = new ZigueZague("villain.png");
        zz.setPosicao(5, 5);
        this.addPersonagem(zz);
        

        Arvore arvore = new Arvore();
        arvore.setPosicao(2, 0);
        this.addPersonagem(arvore);
       
        Floor1 floor1 = new Floor1();
        floor1.createFloor1(e, this);
        */
    }   
